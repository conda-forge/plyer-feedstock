...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/plyer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14252&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/plyer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `plyer` can be installed with:

```
conda install plyer
```

It is possible to list all of the versions of `plyer` available on your platform with:
